...
Building out actual machine learning skills (most likely domain related) is in the works. But I can in fact generalize what I have to some data analysis and creating simple dashboards!
